...
EXEC {databaseOwner}{objectQualifier}AddUser 0, @UserName, 'testuserFN', 'testuserLN', null, 0, @Email, 'Testuser DN', 0, 1, 1
...
EXEC {databaseOwner}{objectQualifier}AddUserRole 1, @NewUserID, 1, 1, 0, null, null, 1