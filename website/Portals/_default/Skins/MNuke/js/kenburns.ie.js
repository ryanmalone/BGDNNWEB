(function($) {
	$(document).ready(function() {
		...
		kenburns($('#mj-slideshow-slide-1 .mj-slideshow-slide-content'));
		...
		function transitionIn(index) {
			...
			kenburns(slide.find('.mj-slideshow-slide-content'));
		}
		...
		function kenburns(el) {
			if (direction == 0) {
				el.css({ "left" : 0, "top" : 0 }).stop().animate({ "left" : 0, "top" : 0 }, slideDuration+500);
			}
			if (direction == 1) {
				el.css({ "left" : -306.66666666667, "top" : 0 }).stop().animate({ "left" : 0, "top" : 0 }, slideDuration+500);
			}
			if (direction == 2) {
				el.css({ "left" : 0, "top" : -193.33333333333 }).stop().animate({ "left" : 0, "top" : 0 }, slideDuration+500);
			}
			if (direction == 3) {
				el.css({ "left" : -306.66666666667, "top" : -193.33333333333 }).stop().animate({ "left" : 0, "top" : 0 }, slideDuration+500);
				direction = -1;
			}
			direction++;


			el.find('img').css({ "width" : sliderWidth*1.4 }).stop().animate({ "width" : sliderWidth }, slideDuration+500);
		}
		// ----------------------------------------------------------
