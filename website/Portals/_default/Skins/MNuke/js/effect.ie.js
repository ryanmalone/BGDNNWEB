(function($) {
	$(document).ready(function() {
		...
		html += "\t.mj-slideshow-wrap:hover .mj-slideshow-arrow-next { opacity: 1; -ms-filter: \"progid:DXImageTransform.Microsoft.Alpha(Opacity=100)\"; -ms-filter: \"progid:DXImageTransform.Microsoft.gradient(startColorstr=#00FFFFFF,endColorstr=#00FFFFFF)progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled='true',sizingMethod='crop',src='modules/mod_slider/images/arrow_next.png')\"; background: transparent\9; }\n";
		html += "\t.mj-slideshow-wrap:hover .mj-slideshow-arrow-prev { opacity: 1; -ms-filter: \"progid:DXImageTransform.Microsoft.Alpha(Opacity=100)\"; -ms-filter: \"progid:DXImageTransform.Microsoft.gradient(startColorstr=#00FFFFFF,endColorstr=#00FFFFFF)progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled='true',sizingMethod='crop',src='modules/mod_slider/images/arrow_prev.png')\"; background: transparent\9; }\n";
