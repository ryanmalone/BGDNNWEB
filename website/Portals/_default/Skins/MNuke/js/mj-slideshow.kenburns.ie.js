(function($) {
	$(document).ready(function() {
		...
		function kenburns(el) {
			...
			if (direction == 1) {
				el.css({ "left" : -[slide_offset_x], "top" : 0 }).stop().animate({ "left" : 0, "top" : 0 }, slideDuration+500);
			}
			if (direction == 2) {
				el.css({ "left" : 0, "top" : -[slide_offset_y] }).stop().animate({ "left" : 0, "top" : 0 }, slideDuration+500);
			}
			if (direction == 3) {
				el.css({ "left" : -[slide_offset_x], "top" : -[slide_offset_y] }).stop().animate({ "left" : 0, "top" : 0 }, slideDuration+500);
				direction = -1;
			}
			direction++;
