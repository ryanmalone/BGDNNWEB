...
<div id="mj-container">
    ...
    <a href="/portals/_default/skins/mnuke/#" class="show_hide searchhide">Search</a>
    <div class="slidingDiv">
		<label class="seechlbl" for="mod-search-searchword">Search...</label>
			<input name="searchword" id="mod-search-searchword" maxlength="20"  class="inputbox mj-search mj-grid24 mj-rspace" type="text" size="20" value="Search..."  onblur="if (this.value=='') this.value='Search...';" onfocus="if (this.value=='Search...') this.value='';" /><input type="submit" value="Go" class="button searchbtn mj-search mj-grid24 mj-rspace" onclick="this.form.searchword.focus();"/>	<input type="hidden" name="task" value="search" />
    ...
    <div id="mj-maincontent">
        <div class="mj-subcontainer">
            ...
            <div id="mj-contentarea" class="mj-grid72">
                <div id="mj-content">
                    <div id="contentarea" class="contentPane" runat="server"></div>
                </div>
            </div>
        </div>
    </div>
